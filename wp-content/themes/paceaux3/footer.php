		...
		<footer <?php hybrid_attr( 'footer' ); ?>>
			...
			<small class="credit g-footer__credit">
				<?php printf(
					...
					esc_html__('Copyright &#169; %1$s %2$s. Powered by %3$s. <a href="%4$s">Privacy Policy</a>', 'drop-shipping' ), 
					date_i18n( 'Y' ), hybrid_get_site_link(), hybrid_get_wp_link(), "/privacy-policy"
				); ?>
			</small><!-- .credit -->
