...
function hybrid_attr_header( $attr ) {
	...
	$attr['id']        = 'header';
	$attr['class']     = 'site-header g-header';
	$attr['role']      = 'banner';
	$attr['itemscope'] = 'itemscope';
...
function hybrid_attr_footer( $attr ) {
	...
	$attr['id']        = 'footer';
	$attr['class']     = 'site-footer g-footer';
...
function hybrid_attr_sidebar( $attr, $context ) {
	...
	$attr['class'] = 'sidebar pageContainer__sidebar';
...
function hybrid_attr_menu( $attr, $context ) {
	...
	if ( $context ) {
		...
		$attr['class'] .= " menu-{$context} nav__{$context}";
...
function hybrid_attr_branding( $attr ) {
	...
	$attr['id']    = 'branding';
	$attr['class'] = 'site-branding g-header__branding';
...
function hybrid_attr_site_title( $attr ) {
	...
	$attr['id']       = 'site-title';
	$attr['class']    = 'site-title g-header__siteTitle';
...
function hybrid_attr_site_description( $attr ) {
	...
	$attr['class']    = 'site-description g-header__siteDescription';
