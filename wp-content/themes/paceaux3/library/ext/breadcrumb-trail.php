	...
	public function trail() {
		...
		if ( 0 < $item_count ) {
			...
			if ( true === $this->args['show_browse'] )
				$breadcrumb .= sprintf( '<h2 class="breadcrumbs__title">%s</h2>', $this->labels['browse'] );

			// Open the unordered list.
			$breadcrumb .= '<ul class="breadcrumbs__list" itemscope itemtype="http://schema.org/BreadcrumbList">';
			...
			foreach ( $this->items as $item ) {
				...
				$item_class = 'breadcrumbs__listItem';
